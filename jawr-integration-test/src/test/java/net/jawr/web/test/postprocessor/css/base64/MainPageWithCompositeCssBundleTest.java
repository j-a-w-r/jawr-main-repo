 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/postprocessor/css/base64/config/web.xml", jawrConfig = "net/jawr/web/postprocessor/css/base64/config/jawr-composite.properties")
public class MainPageWithCompositeCssBundleTest extends AbstractPageTest {
	...
	protected String getPageUrl() {
		return SERVER_URL + CONTEXT_PATH+"/index-with-composite-css-bundle.jsp";
	}
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/css/base64/resources/index-jsp-result-composite-expected.txt", page);
	}
	...
	public void checkGeneratedCssLinks() {
		...
		assertEquals(
				CONTEXT_PATH+"/70545232.@/css/compositeBundle.css",
				css.getHrefAttribute());
	...
	public void testCssBundleContent() throws Exception {
		...
		css = styleSheets.get(1);
		page = getCssPage(css);
		assertContentEquals("/net/jawr/web/postprocessor/css/base64/resources/compositeBundle-expected.css", page);
	}
