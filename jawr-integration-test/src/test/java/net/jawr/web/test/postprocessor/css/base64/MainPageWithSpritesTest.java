 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/postprocessor/css/base64/config/web.xml", jawrConfig = "net/jawr/web/postprocessor/css/base64/config/jawr-with-sprites.properties")
public class MainPageWithSpritesTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/css/base64/resources/index-jsp-result-sprite-expected.txt", page);
	}
	...
	public void checkGeneratedCssLinks() {
		...
		assertEquals(
				getUrlPrefix()+"/N1899889481.@/fwk/core/component.css",
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/css/base64/resources/component-sprite-expected.css", page);
	}
