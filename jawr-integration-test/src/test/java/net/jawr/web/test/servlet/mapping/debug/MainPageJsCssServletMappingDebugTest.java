...
public class MainPageJsCssServletMappingDebugTest extends MainPageJsCssServletMappingTest {
	...
	public void checkGeneratedCssLinks() {
		...
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/cssJawr/jawr_generator.css?d=11111&generationConfigParam=jar%3Afwk%2Fcss%2Ftemp.css",
				css.getHrefAttribute());
		
		css = (HtmlLink) styleSheets.get(1);
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/cssJawr/css/one.css?d=11111",css.getHrefAttribute());
	}
