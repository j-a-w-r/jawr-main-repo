 ...
 * 
 */
package net.jawr.web.test.cache;
 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/cache/config/web.xml", jawrConfig = "net/jawr/web/cache/config/jawr.properties")
