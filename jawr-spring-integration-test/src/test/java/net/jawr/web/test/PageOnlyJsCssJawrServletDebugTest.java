 ...
 */
@JawrSpringTestConfigFiles(webXml = "net/jawr/web/standard/config/web-without-img-servlet.xml", jawrConfig = "net/jawr/web/standard/config/jawr-without-img-servlet-debug.properties",
...
public class PageOnlyJsCssJawrServletDebugTest extends PageOnlyJsCssJawrServletTest {
	...
	public void checkGeneratedJsLinks() {
		...
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/spring/jawr/jawr_generator.js?d=11111&generationConfigParam=messages%3Amessages%40en_US",
				script.getSrcAttribute());
		script = (HtmlScript) scripts.get(1);
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/spring/jawr/jawr_generator.js?d=11111&generationConfigParam=testJs%3AgeneratedContent.js",
				script.getSrcAttribute());
	}
	...
	public void checkGeneratedCssLinks() {
		...
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/spring/jawr/jawr_generator.css?d=11111&generationConfigParam=jar%3Afwk%2Fcss%2FcssWithAbsoluteImg.css",
				css.getHrefAttribute());
		
		css = (HtmlLink) styleSheets.get(1);
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/spring/jawr/css/one.css?d=11111",css.getHrefAttribute());
