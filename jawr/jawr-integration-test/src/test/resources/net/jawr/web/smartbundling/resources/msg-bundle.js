...
ret[a]=arguments[x][a];}
return ret;}
window.messages=({ui:{msg:{hello:{world:p("Hello $ world!")},salute:p("Mr.")}}})})();;function foo(){};window.jawr={};window.jawr.index=function(){alert(messages.ui.msg.hello.world());}
window.jawr.index=function(){alert(mynamespace.ui.msg.hello.world());}