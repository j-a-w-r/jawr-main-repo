 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/generator/skin/standard/config/web-with-binarypath.xml", jawrConfig = "net/jawr/web/generator/skin/standard/config/jawr.properties")
public class MainPageGeneratedResourceSkinWithBinaryPathTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/standard/resources/index-jsp-result-with-binarypath-expected.txt", page);
	}
	...
	public void checkGeneratedCssLinks() {
		...
		assertEquals(
				getUrlPrefix()+"/N1023758481.en_US@summer/fwk/core/component.css",
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/skin/standard/resources/component-with-binarypath-expected.css", page);
	}
