 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/smartbundling/config/web.xml", jawrConfig = "net/jawr/web/smartbundling/config/jawr-jmx.properties")
public class MainPageJMXTest extends MainPageTest {

	protected static String getTempFolder() {
		return "jawr-integration-smartbundling-test-jmx-1";
	}
