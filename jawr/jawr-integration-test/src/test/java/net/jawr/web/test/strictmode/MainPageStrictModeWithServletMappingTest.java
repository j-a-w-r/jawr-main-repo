 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/strictmode/config/web-with-servlet-mapping.xml", jawrConfig = "net/jawr/web/strictmode/config/jawr-strict-mode.properties")
public class MainPageStrictModeWithServletMappingTest extends AbstractPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals(
				"/net/jawr/web/strictmode/resources/index-jsp-result-expected.txt",
				page);
	}
	...
	public void checkGeneratedJsLinks() throws FailingHttpStatusCodeException,
		...
		int status = webClient
				.getPage(getServerUrlPrefix() + getUrlPrefix() + "/jawrJS/777777.en_US/js/bundle/msg.js")
	...
	public void checkGeneratedCssLinks() throws FailingHttpStatusCodeException,
		...
		assertEquals(getUrlPrefix() + "/jawrCSS/N480088113/fwk/core/component.css",
		...
		webClient.setThrowExceptionOnFailingStatusCode(false);
		int status = webClient
				.getPage(getServerUrlPrefix() + getUrlPrefix() + "/jawrCSS/777777/fwk/core/component.css")
				.getWebResponse().getStatusCode();
	...
	public void checkAccessToJsResourceNotHandlerByJawr() throws FailingHttpStatusCodeException,
		...
		WebClient webClient = new WebClient();
		webClient.setThrowExceptionOnFailingStatusCode(false);
		String resource = getServerUrlPrefix() + getUrlPrefix() + "/jawrJS/js/index/index.js";
		int status = webClient
				.getPage(resource)
				.getWebResponse().getStatusCode();
	...
	public void checkAccessToCssResourceNotHandlerByJawr() throws FailingHttpStatusCodeException,
		...
		WebClient webClient = new WebClient();
		webClient.setThrowExceptionOnFailingStatusCode(false);
		String resource = getServerUrlPrefix() + getUrlPrefix() + "/jawrCSS/css/one.css";
		int status = webClient
				.getPage(resource)
				.getWebResponse().getStatusCode();
	...
	public void checkAccessToBinaryResourceNotHandlerByJawr() throws FailingHttpStatusCodeException,
		...
		WebClient webClient = new WebClient();
		webClient.setThrowExceptionOnFailingStatusCode(false);
		String resource = getServerUrlPrefix() + getUrlPrefix() + "/jawrBin/img/logo.png";
		int status = webClient
				.getPage(resource)
				.getWebResponse().getStatusCode();
	...
	public void checkAccessToWebXml() throws FailingHttpStatusCodeException,
		...
		webClient.setThrowExceptionOnFailingStatusCode(false);
		int status = webClient
				.getPage(getServerUrlPrefix() + getUrlPrefix() + "/jawrJS/WEB-INF/web.xml")
				.getWebResponse().getStatusCode();

		assertEquals(404, status);
		
		status = webClient
				.getPage(getServerUrlPrefix() + getUrlPrefix() + "/jawrCSS/WEB-INF/web.xml")
				.getWebResponse().getStatusCode();
		...
		status = webClient
				.getPage(getServerUrlPrefix() + getUrlPrefix() + "/jawrBin/WEB-INF/web.xml")
				.getWebResponse().getStatusCode();
