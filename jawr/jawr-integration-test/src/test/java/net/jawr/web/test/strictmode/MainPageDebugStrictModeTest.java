 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/debug/config/web.xml", jawrConfig = "net/jawr/web/strictmode/config/jawr-debug-strict-mode.properties")
public class MainPageDebugStrictModeTest extends MainPageStrictModeTest {
