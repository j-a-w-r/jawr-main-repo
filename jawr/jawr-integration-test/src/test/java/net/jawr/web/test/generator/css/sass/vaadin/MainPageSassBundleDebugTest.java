...
/**
 * Test case for Sass Vaadin Generator in debug mode.
 * 
 * @author ibrahim Chaehoi
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/standard/config/web.xml", jawrConfig = "net/jawr/web/generator/css/sass/vaadin/debug/config/jawr.properties")
public class MainPageSassBundleDebugTest extends MainPageSassBundleTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/css/sass/vaadin/debug/resources/index-jsp-result-debug-mode-expected.txt", page);
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/css/sass/vaadin/debug/resources/imports_sass.css", page);
		
		css = (HtmlLink) styleSheets.get(1);
		page = getCssPage(css);
		assertContentEquals("/net/jawr/web/generator/css/sass/vaadin/debug/resources/jar_temp.css", page);
		
		
		css = (HtmlLink) styleSheets.get(2);
		page = getCssPage(css);
		assertContentEquals("/net/jawr/web/generator/css/sass/vaadin/debug/resources/one.css", page);
