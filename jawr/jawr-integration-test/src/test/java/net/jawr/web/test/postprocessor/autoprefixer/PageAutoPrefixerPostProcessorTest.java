 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/postprocessor/css/autoprefixer/config/web.xml", jawrConfig = "net/jawr/web/postprocessor/css/autoprefixer/config/jawr.properties")
public class PageAutoPrefixerPostProcessorTest extends MainPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/css/autoprefixer/resources/index-jsp-result-expected.txt", page);
	}
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/css/autoprefixer/resources/component-expected.css", page);
	}
}
