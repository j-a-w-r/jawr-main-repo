 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/standard/config/web.xml", jawrConfig = "net/jawr/web/standard/config/jawr-with-external-bundle.properties")
public class MainPageWithExternalBundleTest extends MainPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals(
				"/net/jawr/web/standard/resources/index-with-external-bundle-jsp-result-expected.txt",
				page);
	}
	...
	public void checkGeneratedJsLinks() {
		...
		assertEquals("http://mycomp/js/foo.min.js",
