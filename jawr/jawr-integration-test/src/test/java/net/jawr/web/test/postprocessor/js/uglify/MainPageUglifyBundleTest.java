 ...
 * 
 */
package net.jawr.web.test.postprocessor.js.uglify;
 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/postprocessor/js/uglify/config/web.xml", jawrConfig = "net/jawr/web/postprocessor/js/uglify/config/jawr.properties")
public class MainPageUglifyBundleTest extends MainPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/js/uglify/resources/index-jsp-result-expected.txt", page);
	}
	...
	public void checkGeneratedJsLinks() {
		...
		assertEquals(
				getUrlPrefix()+"/N1644166760.en_US/js/bundle/msg.js",
	...
	public void testJsBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/js/uglify/resources/msg-bundle.js", page);
	}
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/postprocessor/js/uglify/resources/component-expected.css", page);
	}
