 ...
 */
@JawrTestConfigFiles(webXml = "net/jawr/web/standard/config/web.xml", jawrConfig = "net/jawr/web/generator/css/less/standard/config/jawr.properties")
public class MainPageLessBundleTest extends MainPageTest {
	...
	public void testPageLoad() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/css/less/standard/resources/index-jsp-result-expected.txt", page);
	}
	...
	public void checkGeneratedCssLinks() {
		...
		assertEquals(getUrlPrefix()+"/N1867482054/fwk/core/component.css",
	...
	public void testCssBundleContent() throws Exception {
		...
		assertContentEquals("/net/jawr/web/generator/css/less/standard/resources/component-expected.css", page);
	}
