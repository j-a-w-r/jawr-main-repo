...
public class SmartSpritesResourceHandler implements ResourceHandler {
	...
	private final ResourceReaderHandler imgRsHandler;

	/** The Css generator registry */
	private final GeneratorRegistry cssGeneratorRegistry;

	/** The binary resource generator registry */
	private final GeneratorRegistry binaryGeneratorRegistry;
	 ...
	 * 
	 * @param rsHandler
	 *            the CSS resource handler
	 * @param imgRsHandler
	 *            the image resource handler
	 * @param cssGeneratorRegistry
	 *            the css generator registry
	 * @param imgGeneratorRegistry
	 ...
	 *            the message log
	 */
	public SmartSpritesResourceHandler(ResourceReaderHandler rsHandler, ResourceReaderHandler imgRsHandler,
			GeneratorRegistry cssGeneratorRegistry, GeneratorRegistry imgGeneratorRegistry, String charset,
	 ...
	 * 
	 * @see
	 * org.carrot2.labs.smartsprites.resource.ResourceHandler#getReader(java.
	 * lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.carrot2.labs.smartsprites.resource.ResourceHandler#
	 ...
	 * 
	 * @see
	 * org.carrot2.labs.smartsprites.resource.ResourceHandler#getResourcePath(
	 ...
	 * 
	 * @see org.carrot2.labs.smartsprites.resource.ResourceHandler#
	 * getResourceAsOutputStream(java.lang.String)
	 */
	@Override
	public OutputStream getResourceAsOutputStream(String resourceName) throws IOException {
		...
		if (!FileNameUtils.isExtension(generatedFilePath, JawrConstant.CSS_TYPE)
				&& binaryGeneratorRegistry.isGeneratedBinaryResource(generatedFilePath)) {
			// for generated image put it in the generated Image directory
			generatedFilePath = workingDir + JawrConstant.SPRITE_GENERATED_IMG_DIR
					+ generatedFilePath.replace(':', '/');
		} else if (cssGeneratorRegistry.isPathGenerated(generatedFilePath)) { // Rename
																				// resource
																				// for
																				// For
																				// generated
																				// CSS
			generatedFilePath = workingDir + JawrConstant.SPRITE_GENERATED_CSS_DIR
					+ generatedFilePath.replace(':', '/');
		} else {
	 ...
	 * 
	 * @see org.carrot2.labs.smartsprites.resource.ResourceHandler#
	 * getResourceAsWriter(java.lang.String)
	 */
	@Override
