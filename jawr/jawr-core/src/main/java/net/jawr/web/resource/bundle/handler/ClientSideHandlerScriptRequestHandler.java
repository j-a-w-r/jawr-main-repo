...
public class ClientSideHandlerScriptRequestHandler implements Serializable {
	...
	/**
	 * Placeholder for a script stringbuffer and its hashcode, meant to avoid
	 * constant recalculation of the hash value.
	 * 
	 * @author Jordi Hernández Sellés
	 */
	...
	/**
	 * Generates a locale dependent script used to include bundles in non
	 * dynamic html pages. Uses a cache of said scripts to avoid constant
	 * regeneration. It also keeps track of eTags and if-modified-since headers
	 * to take advantage of client side caching.
	 * 
	 * @param request
	 *            the request
	 * @param response
