...
/**
 * This class defines the resource bundle handler which is based on the servlet
 * context.
 * 
...
public class ServletContextResourceBundleHandler extends AbstractResourceBundleHandler {
	 ...
	 *            the resource type
	 */
	public ServletContextResourceBundleHandler(ServletContext context, Charset charset,
			GeneratorRegistry generatorRegistry, String resourceType) {
		super(new File((File) context.getAttribute(JawrConstant.SERVLET_CONTEXT_TEMPDIR), JawrConstant.JAWR_WRK_DIR),
				charset, generatorRegistry, resourceType);
	 ...
	 *            the resource type
	 */
	public ServletContextResourceBundleHandler(ServletContext context, String workingDirectory, Charset charset,
			GeneratorRegistry generatorRegistry, String resourceType) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.jawr.web.resource.handler.bundle.ResourceBundleHandler#
	 * getResourceBundleAsStream(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.jawr.web.resource.handler.bundle.AbstractResourceBundleHandler#
	 * doGetResourceAsStream(java.lang.String)
	 */
	@Override
