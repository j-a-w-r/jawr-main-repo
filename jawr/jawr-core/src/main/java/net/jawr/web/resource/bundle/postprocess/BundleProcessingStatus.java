...
public class BundleProcessingStatus {
	...
	/**
	 * The flag indicating if the post processor must search for post process
	 * variants or not
	 */
	private boolean searchingPostProcessorVariants = true;

	/** The map of current variants of the bundle to process */
	private Map<String, String> bundleVariants = new HashMap<>();

	/** The map of variants which must be generated from the post processors */
	private Map<String, VariantSet> postProcessVariants = new HashMap<>();
	 ...
	 * 
	 * @param searchingPostProcessorVariants
	 *            the flag to set
	 */
	 ...
	 * 
	 * @param bundleVariants
	 *            the bundle variants to set
	 */
	...
	public void addPostProcessVariant(Map<String, VariantSet> variants) {
		...
		if (!searchingPostProcessorVariants) {
			throw new BundlingProcessException(
					"You are not allowed to define post process variants if we are not searching for post processor variants.");
		}
