...
public class InclusionPattern {
	 ...
	 * 
	 * @param isGlobal
	 *            If true, the bundle will be included before every other
	 *            bundle.
	 * @param inclusionOrder
	 *            When isGlobal is true, this will set the order of inclusion of
	 *            this bundle with respect to other global bundles.
	 * @param inclusion
	 *            the inclusion property in debug mode.
	 */
	public InclusionPattern(boolean isGlobal, int inclusionOrder, DebugInclusion inclusion) {
		super();
	...
	/**
	 * Create a new inclusion pattern for a bundle to include in debug and
	 * non-debug mode. .
	 * 
	 * @param isGlobal
	 *            If true, the bundle will be included before every other
