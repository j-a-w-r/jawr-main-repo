...
java_import "net.jawr.web.resource.bundle.generator.css.sass.ruby.JawrSassResolver"

module Sass
  module Importers
	class JawrImporter < Base
      ...
      def find_relative(uri, base, options)
        ...
        path = @resolver.getPath(base, uri)
        #TODO fix this
        ...
        content = @resolver.find_relative(base, uri)
      ...
      def find(uri, options)
        ...
        #options[:filename] = path
        options[:importer] = self
        content = @resolver.find(uri, options)
        Sass::Engine.new(content, options)
      ...
      def mtime(uri, options)
        ...
        @resolver.getLastModificationDate(uri)
      end
