...
<html>
<head>    
 <jwr:style src="/component.css" media="all" />
 <jwr:script src="/js/bundle/msg.js" />
 <jwr:script src="/js/bundle/main.js" />
...
<script type="text/javascript">
	alert("A little message retrieved from the message bundle : "+mynamespace.ui.msg.hello.world());
</script>
</body>
</html>
