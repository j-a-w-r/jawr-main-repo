...
/**
 * The class defines the abstract class for skin variant resolver, which is used to determine 
 * the current skin from the HTTP request.
 *  
...
public abstract class AbstractCssSkinVariantResolver implements VariantResolver {
	...
	/**
	 * @param skinCookieName the skinCookieName to set
	 */
