 ...
 */
@JawrSpringTestConfigFiles(webXml = "net/jawr/web/standard/config/web.xml", jawrConfig = "net/jawr/web/debug/config/jawr.properties",
...
public class PageInSubDirDebugTest extends PageInSubDirTest {
	...
	public void checkGeneratedCssLinks() {
		...
		Utils.assertGeneratedLinkEquals(
				getUrlPrefix()+"/spring/jawr/jawr_generator.css?d=11111&generationConfigParam=jar%3Afwk%2Fcss%2Ftemp.css",
