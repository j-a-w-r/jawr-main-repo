...
ret[a]=arguments[x][a];}
return ret;}
window.messages=({ui:{msg:{hello:{world:p("Hello $ world!")},salute:p("Mr.")}}})})();;function foo(){};function update(){var name=dwr.util.getValue("demoName");Demo.sayHello(name,function(data){dwr.util.setValue("demoReply",data);});}
